...
@bot.command(name='boringjoke', help='Cuenta un chiste aburrido de forma aleaoria.')
async def chiste(ctx):
    message =  ctx.message.content
    print("send a new mesage to rabbitmq: "+message)

    channelMQ.basic_publish(exchange='cartero', routing_key="boringjoke", body=message)
